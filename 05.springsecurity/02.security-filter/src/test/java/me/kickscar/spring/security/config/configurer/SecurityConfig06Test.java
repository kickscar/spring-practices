...
import me.kickscar.spring.security.config.configurer.SecurityConfig06;
...
@ContextConfiguration(classes={WebConfig.class, SecurityConfig06.class})
@WebAppConfiguration
public class SecurityConfig06Test {
    private MockMvc mvc;
    ...
    public void testSecurityConfiguration(WebApplicationContext context) {
        ...
        /*
            -- Filter Ordering --
             ...
             21. AuthorizationFilter                                16* : 접근 권한이 있는지 확인하고 처리하는 필터
        */
